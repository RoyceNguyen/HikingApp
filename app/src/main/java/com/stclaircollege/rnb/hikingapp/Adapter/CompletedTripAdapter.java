...
public class CompletedTripAdapter extends RecyclerView.Adapter<CompletedTripAdapter.ViewHolder> {
    ...
    public CompletedTripAdapter(Context context, List<Trip> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_completed_trip, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public TextView text_trip_enddate;
        public ViewHolder(View itemView) {
            ...
            text_trip_enddate = itemView.findViewById(R.id.text_trip_enddate);
